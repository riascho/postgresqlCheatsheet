...
- [Basics](#basics)
  ...
  - [Creating a database / table](#creating-a-database--table)
    - [Creating a table from another table (duplicating)](#creating-a-table-from-another-table-duplicating)
  ...
  - [Constraints & Data Integrity](#constraints--data-integrity)
    ...
    - [UNIQUE](#unique)
    - [CHECK](#check)
    - [Deleting Constraints](#deleting-constraints)
  ...
  - [Column Referencing](#column-referencing)
  - [Case Statement](#case-statement)
  - [Aggregation](#aggregation)
  - [Date & Time](#date--time)
  - [COALESCE & NULL](#coalesce--null)
  - [Type Casting](#type-casting)
  - [Inserting into a Table](#inserting-into-a-table)
  - [Conflict Handling](#conflict-handling)
  - [Update a Table Record](#update-a-table-record)
  - [Delete a Table Record](#delete-a-table-record)
  - [INNER JOINS](#inner-joins)
  - [LEFT JOINS](#left-joins)
  - [CROSS JOINS](#cross-joins)
  - [UNIONS](#unions)
  - [WITH AS / Common Table Expressions (CTE)](#with-as--common-table-expressions-cte)
  - [Generate CSV](#generate-csv)
  - [Sequencing](#sequencing)
  - [Triggers](#triggers)
  - [Functions](#functions)
- [Permissions & Roles in postgres](#permissions--roles-in-postgres)
- [Extensions](#extensions)
- [Important Keyboard Shortcut Commands](#important-keyboard-shortcut-commands)
- [Understanding postgres structure](#understanding-postgres-structure)
...
- [Indexing](#indexing)
  - [Querying in Postgres](#querying-in-postgres)
    - [Seek vs Scan](#seek-vs-scan)
  - [Costs](#costs)
  - [Multi-column indexes](#multi-column-indexes)
  - [Partial Indexes](#partial-indexes)
  - [Ordered Indexes](#ordered-indexes)
  - [Clustering](#clustering)
  - [Indexes with Functions (Expressions)](#indexes-with-functions-expressions)
  - [Summary](#summary)
- [Data Security](#data-security)
  - [Role-Based Access Control](#role-based-access-control)
    - [Roles](#roles)
    - [The Principle of Least Priviledge](#the-principle-of-least-priviledge)
    - [RBAC Design](#rbac-design)
  - [Authentication and Authorization in Postgres](#authentication-and-authorization-in-postgres)
    - [Host-Based Authentication](#host-based-authentication)
    - [Creating and Granting Rules in Postgres](#creating-and-granting-rules-in-postgres)
